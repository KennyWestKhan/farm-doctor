...
const STRINGS = {
  ...
  home_scan_desc: { en: 'Take a photo — the fastest way to check', twi: 'Twa mfoniɛ — ɛyɛ ntɛm sen biara' },
  home_questions_cta: { en: 'Answer questions instead', twi: 'Bua nsɛmmisa mmom' },
  home_questions_desc: { en: 'No camera? Check by symptoms', twi: 'Camera nni hɔ? Fa nsɛnkyerɛnneɛ hwɛ' },
  home_questions_offline_desc: { en: 'Works offline — check by symptoms', twi: 'Ɛyɛ adwuma a intanɛt nni hɔ' },
  home_scan_needs_net: { en: 'Needs internet for the AI', twi: 'Ehia intanɛt ansa' },
  ...
  scan_crop_pick: { en: 'Which crop are you scanning?', twi: 'Mfudeɛ bɛn na wore scan?' },
  scan_crop_pick_cta: { en: 'Next — take photo', twi: 'Toa so — twa mfonin' },
  scan_crop_unsure: { en: "Not sure — detect from photo", twi: 'Mennim — ma mfonin no nkyerɛ' },
  scan_crop_detecting: { en: 'We will detect the crop from your photo', twi: 'Yɛbɛhwehwɛ mfudeɛ no wɔ wo mfonin no mu' },
